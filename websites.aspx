<%@ Page Title="apsFeatures - Build Websites " Language="C#" MasterPageFile="~/site.master" AutoEventWireup="true" CodeFile="websites.aspx.cs" Inherits="websites" %>
    ...
    <section class="breadcrumbs">
      <div class="container">
        ...
        <div class="d-flex justify-content-between align-items-center">
          <h2>Build Websites</h2>
          <ol>
            <li><a href="home.aspx">Home</a></li>
            <li>Builds Websites</li>
          </ol>
        </div>
      </div>
    </section>
    ...
    <div class="container">
        <div class="row gy-4">
            <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center">
                <h1>Want a <span style="color:#ff6a00;">Website</span> very quick?</h1>
          ...
          <img src="assets/img/services/websites.svg" class="img-fluid animated" alt="">
        </div>
        </div>
    </div>
</section>
    ...
    <div class="container d-flex">
        <div class="row gy-4">
            <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column mt-5">
                <img src="assets/img/services/web2.svg" class="img-fluid" alt="" width="550">
            </div>

            <div class="col-lg-6 order-1 order-lg-2">
            <h1>Website Builders</h1>
            <h2>We have very creative designer and skilled developers, we can turn your ideas into reality or you want to take your bussiness online we can do both.</h2>
            <p class="mt-3" style="font-size:1.5rem;">We create all types of websites as you desire:</p>
             <ul>
                <li>Landing Page</li>
                <li>Personal Portfolio</li>
                <li>E-commerce Website</li>
                <li>Professional Bussiness Websites</li>
                <li>Personal Blogs</li>
                <li>Small Bussiness Websites</li>
                <li>Non-Profit Websites</li>
                 <li>Entertainment Websites or Media Websites</li>
            </ul>        
            </div>
        </div>
    </div>
