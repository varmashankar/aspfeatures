<%@ Page Title="apsFeatures - Mobile Applications" Language="C#" MasterPageFile="~/site.master" AutoEventWireup="true" CodeFile="mobileapplications.aspx.cs" Inherits="mobileapplications" %>
    ...
    <div class="container">
        <div class="row gy-4">
            <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center">
                <h1>Convert Your Website into <span style="color:#ff6a00;">Mobile Application</span>!</h1>
          ...
          <img src="assets/img/services/mobile.svg" class="img-fluid animated" alt="">
        </div>
        </div>
    </div>
</section>
    ...
    <div class="container d-flex">
        <div class="row gy-4">
            <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column mt-5">
                <img src="assets/img/services/mob2.svg" class="img-fluid" alt="" width="550">
            </div>

            <div class="col-lg-6 order-1 order-lg-2">
            <h1>Mobile Applications</h1>
            <h2>We can convert your websites into mobile application jus like your website, we can also help you to bring your idea into reality.</h2>
