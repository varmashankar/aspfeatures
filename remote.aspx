<%@ Page Title="apsFeatures - Remote Support" Language="C#" MasterPageFile="~/site.master" AutoEventWireup="true" CodeFile="remote.aspx.cs" Inherits="remote" %>
    ...
    <div class="container">
        <div class="row gy-4">
            <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center">
                <h1>Our <span style="color:#ff6a00;">Remote Services</span> are fast & efficient</h1>
          ...
          <img src="assets/img/services/remote.svg" class="img-fluid animated" alt="">
        </div>
        </div>
    </div>
</section>
    ...
    <div class="container d-flex">
        <div class="row gy-4">
            <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column mt-5">
                <img src="assets/img/services/remote2.svg" class="img-fluid" alt="" width="550">
            </div>

            <div class="col-lg-6 order-1 order-lg-2">
            <h1>Remote Services</h1>
            <h2>A remote service is a process that resides outside of the application server and provides a service to the application. An example of a remote service is a web service, message queue, or caching server.</h2>
            <p class="mt-3" style="font-size:1.5rem;">What we provide remotely:</p>
             <ul>
                <li>Troubleshooting you issues</li>
                <li>Software Issues</li>
                <li>Network Issues</li>
                <li>Websites Small Updates or Changes</li>
                <li>Mobile Applications Issues</li>
                <li>Personal Technical Support</li>
                <li>Queries Related to our services</li>
            </ul>        
            </div>
        </div>
    </div>
