<%@ Page Title="apsFeatures - Troubleshoot" Language="C#" MasterPageFile="~/site.master" AutoEventWireup="true" CodeFile="troubleshoot.aspx.cs" Inherits="troubleshoot" %>
    ...
    <div class="container">
        <div class="row gy-4">
            <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center">
                <h1>Let us help you <span style="color:#ff6a00;">Troubleshoot</span> Your Problems!</h1>
          ...
          <img src="assets/img/services/trouble2.svg" class="img-fluid animated" alt="">
        </div>
        </div>
    </div>
</section>
    ...
    <div class="container d-flex">
        <div class="row gy-4">
            <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column mt-5">
                <img src="assets/img/services/troubleshoot.svg" class="img-fluid" alt="" width="550">
            </div>

            <div class="col-lg-6 order-1 order-lg-2">
            <h1>Troubleshoot</h1>
            <h2>Sometimes peoples don't know what kind of fault they are facing, So here we help you find that fault and solve it.</h2>
            <p class="mt-3" style="font-size:1.5rem;">How are we going to troubleshoot your problem:</p>
             <ul>
                <li>First define the problem</li>
                <li>Identifying the probable cause of the problem</li>
                <li>Create the hypothesis</li>
                <li>Test those hypothesis</li>
                <li>Create a action plan</li>
                <li>Implement action plan</li>
                <li>Verify the Resolution</li>
                <li>Document the Troubleshoot Report</li>
            </ul>        
            </div>
        </div>
    </div>
