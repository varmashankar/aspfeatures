<%@ Page Title="apsFeatures - Hardware" Language="C#" MasterPageFile="~/site.master" AutoEventWireup="true" CodeFile="hardware.aspx.cs" Inherits="hardware" %>
    ...
    <div class="container">
        <div class="row gy-4">
            <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center">
                <h1><span style="color:#ff6a00;">Hardware</span> support for all devices!</h1>
          ...
          <img src="assets/img/services/hardware.svg" class="img-fluid animated" alt="" width="550">
        </div>
        </div>
    </div>
</section>
    ...
    <div class="container d-flex">
        <div class="row gy-4">
            <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column mt-5">
                <img src="assets/img/services/hard2.svg" class="img-fluid" alt="" width="550">
            </div>

            <div class="col-lg-6 order-1 order-lg-2">
            <h1>Hardware Support</h1>
            <h2>We provide preventive and remedial services that physically repair or optimize hardware, including basic installation, contract maintenance and per-incident repair — both on-site and at a centralized repair depot.</h2>
            <p class="mt-3" style="font-size:1.5rem;">We create all types of mobile applications as you desire:</p>
             <ul>
                <li>Graphics/Sound Card</li>
                <li>Motherboard & Power Supply</li>
                <li>Central Processing Unit (CPU)</li>
                <li>Random Access Memory (RAM)</li>
                <li>Monitor/Keyboard/Mouse/Speakers/Printer</li>
                <li>Hard Drive (HHD) & Solid State Drive (SSD)</li>
            </ul>        
            </div>
        </div>
    </div>
